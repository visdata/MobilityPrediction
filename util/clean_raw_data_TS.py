...
filelist = ['part-'+format(n, '05d') for n in range(724)]

input_path = '/enigma/tao.jiang/datasets/JingJinJi/records/TD-rawdata/Tangshan/'
output_path = '/datahouse/yurl/TalkingData/data/TS_cleaned_data/'
