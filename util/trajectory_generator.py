...
input_path = '/datahouse/yurl/TalkingData/data/P3-SS-BJ-resample/'
output_path = '/datahouse/yurl/TalkingData/data/BJ-simulation/'
...
filelist = ['train-10000-' + str(minute) + "-" + str(space) + "-" +format(float(n)/10, '.1f') for n in range(1,11)]
